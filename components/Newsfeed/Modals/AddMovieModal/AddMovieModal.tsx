import { FeedBaseInput, FeedGenresField, FileInput } from '@/components';
import useAddMovie from './useAddMovie';
import { Controller } from 'react-hook-form';
import { FeedTextareaForMovie } from '@/components';
