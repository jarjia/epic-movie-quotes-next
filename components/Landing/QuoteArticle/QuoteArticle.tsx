...
const QuoteArticle: React.FC<QuoteArticleTypes> = (props) => {
  return (
    <article
      ...
      style={{
        backgroundImage: `linear-gradient(180deg, #000000 0%, rgba(0, 0, 0, 0) 55.21%, rgba(0, 0, 0, 0) 100%), url(${props.image})`,
      }}
    >
      <div className='flex flex-col sm:pl-[60px] justify-center pl-[120px] w-full h-full'>
        <div>
          <div>
