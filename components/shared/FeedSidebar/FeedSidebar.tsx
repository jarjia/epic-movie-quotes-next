      ...
      >
        <div className='block sm:hidden'>
          ...
          >
            ...
            <div>
              <h3 className='capitalize text-2xl mid-side:text-xl text-white break-words'>
                {userData?.name}
              </h3>
              <p
                className={`text-sm ${isHovered ? 'text-white' : 'text-input'}`}
              >
                {t('edit_profile')}
              </p>
            </div>
              ...
              <div className='flex flex-col justify-start items-start'>
                ...
                {dropDown && (
                  <div className='relative bottom-12 left-20'>
                    <div
                      ref={dropDownRef}
                      className='z-10 absolute bg-post-bg shadow-2xl divide-y divide-gray-100 rounded-lg'
                    >
