      ...
      <div>
        ...
        <div className='flex sm:flex-col items-start sm:items-start sm:py-2 gap-2 justify-between'>
          <h2 className='flex text-title text-xl'>
            <span className='break-all capitalize max-h-[250px] scrollbar'>
        ...
        <div className='flex mt-2 flex-wrap py-4 gap-1 large:gap-2 sm:gap-2 sm:max-h-full max-h-[156px] sm:overflow-y-auto scrollbar'>
          {props.movie.genres &&
        ...
        <div className='py-1.5'>
          <p className='text-input max-h-[100px] scrollbar text-font-base'>
